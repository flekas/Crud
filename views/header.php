      ...
      <body>	
            ...
            <div class="container">
                  <div class="table_switcher">
                        <form class="well form-inline" action="switch_table.php?referrer=<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
        ...
        <?php 
          ...
          {
                echo '<div class="alert alert-error"><p>Select tables to get started..!</p> </div>';
                die;
          }
